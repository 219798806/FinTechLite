        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LedgerEntries_DebitOrCredit", "([DebitAmount] IS NOT NULL AND [CreditAmount] IS NULL) OR ([DebitAmount] IS NULL AND [CreditAmount] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FromTo",
                table: "Transactions",
                columns: new[] { "FromAccountId", "ToAccountId" });
